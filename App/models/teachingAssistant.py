...
class TeachingAssistant(CreateStaff):
    __tablename__ = 'teachingAssistant'
    taID = db.Column(db.Integer, primary_key=True, unique=True)
    ...
    def __init__(self, taID, staff_id, courseID, course_manager: CreateCourses):
        self.taID = taID
